...
from gpx_view.application.maps import MapErrorCode, MapOperationError, TransferOutcome
...
def user_agent(version: str) -> str:
    ...
    return f"gpx-view/{version} (self-hosted track archive; offline map installer)"
