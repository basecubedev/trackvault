...
generation -- is :class:`~gpx_view.application.normalization.NormalizeRawImport`,
...
from gpx_view.application.ports import Clock, RawArtifactState, RawImportStore, TrackRepository
from gpx_view.domain import InputChannel, RawImport
