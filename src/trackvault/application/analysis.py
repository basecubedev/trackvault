...
The mirror of :mod:`trackvault.application.processing`, one layer further out in
the pipeline. An :class:`~trackvault.domain.analysis.AnalysisProfile` describes
...
from trackvault.application.ports import AnalysisAvailability, AnalysisSnapshot, TrackRepository
from trackvault.domain import TemporalEvidence, supports_actual_timing
