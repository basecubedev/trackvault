...
from trackvault.application.archive import CreateArchive, RestoreArchive
from trackvault.application.export import ExportRawSource, ExportTrackDocument
from trackvault.application.import_tracks import ImportTracks
...
from trackvault.infrastructure.gpx import GpxDocumentWriter, GpxImporter
...
def build_services(settings: Settings) -> TrackServices:
    ...
    return TrackServices(
        ...
        export_document=ExportTrackDocument(
            repository=store, writer=GpxDocumentWriter(generator=f"TrackVault {VERSION}")
        ),
