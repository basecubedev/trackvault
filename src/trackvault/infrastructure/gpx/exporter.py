...
comes from :mod:`trackvault.infrastructure.gpx.extensions`, which stays the one
...
from trackvault.application.export import ExchangeDocument
from trackvault.domain import Activity, TrackPoint, TrackSegment
from trackvault.infrastructure.gpx.extensions import GARMIN_TRACK_POINT_EXTENSION_V2
from trackvault.infrastructure.gpx.importer import GPX_MEDIA_TYPE
from trackvault.infrastructure.gpx.parsing import GPX_1_1_NAMESPACE
