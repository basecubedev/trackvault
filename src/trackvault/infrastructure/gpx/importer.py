...
:mod:`trackvault.infrastructure.gpx.extensions` -- because a local name on its own
...
from trackvault.infrastructure.gpx.activities import normalize_activity, states_an_activity
...
from trackvault.infrastructure.gpx.parsing import (
    ROOT_TAG,
