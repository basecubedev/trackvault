...
from trackvault.infrastructure.private_data import create_private_file
...
_STAGED_DATABASE_MEMBER = "database/trackvault.sqlite3"
...
def sync_directory(directory: Path) -> None:
    ...
    *contents*; the rename that gives those contents their name lives in the
    ...
    Shared with :mod:`trackvault.infrastructure.archive.container`, which ends a
