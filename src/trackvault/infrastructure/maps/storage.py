...
from trackvault.application.maps import MapDownloadSlot, MapErrorCode, MapOperationError
...
class FilesystemMapPackageStorage:
    ...
    def __init__(self, root: Path) -> None:
        ...
        The root is made absolute here, once. `TRACKVAULT_DATA_DIR` defaults to a
